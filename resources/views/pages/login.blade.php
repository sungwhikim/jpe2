        ...
        <div id="loginbox" style="margin-top:150px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-default box-shadow--4dp" >
                <div class="panel-heading">
                    ...
                    <div style="float:right; position: relative; top: -20px"><a href="/password/email">Forgot password?</a></div>
                </div>
                ...
                <div style="padding-top:20px" class="panel-body" >
                    ...
                    <form class="form-horizontal" role="form" method="post" name="mainForm" action="/login">
                        {!! csrf_field() !!}
