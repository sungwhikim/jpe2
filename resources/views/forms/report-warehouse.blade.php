<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 report-control"
    ...
    <select class="form-control" name="warehouse_id" ng-model="ctrl.criteria.warehouse_id" ng-change="ctrl.criteria.client_id=null"
            ng-options="warehouse.id as warehouse.name for warehouse in ctrl.wcList">
