<div class="row col-lg-6 col-md-6 col-sm-6 col-xs-6 form-group" @if( isset($product_page) ) ng-init="mainList.setProductType(item)" @endif
    ...
    <div class="col-lg-8">
        <select class="form-control" name="product_type_id" ng-model="item.product_type_id"
                ...
                @if( isset($product_page) ) ng-change="mainList.setProductType(item)" @endif required>
        </select>
