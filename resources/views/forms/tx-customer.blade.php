<div class="row col-lg-5 col-md-5 col-sm-5 col-xs-5 form-group"
    ...
    <label class="col-lg-12 control-label">
        Customer <span class="required-field glyphicon glyphicon-asterisk"></span>
        <button class="btn btn-warning btn-xs btn-new-customer" type="button" ng-click="txCtrl.newCustomer()">New</button>
    </label>
