<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {{ $container_class }}">
    <div class="panel panel-default panel-checkbox">
        <div class="panel-heading">
            ...
            <button class="btn btn-xs btn-default" ng-click="mainList.allCheckBoxes(mainList.newItem.{{ $name }}, {{ $master_list }})" type="button">All</button>
                ...
                <li class="checkbox">
                    <label>
                        <input type="checkbox" name="{{ $name }}[]" value=""
                               ng-click="mainList.toggleCheckBox(mainList.newItem.{{ $name }}, {{ $item->id }})"
                               ng-checked="mainList.newItem.{{ $name }}.indexOf({{ $item->id }}) > -1">
                        {{ $item->name }}
                    </label>
                </li>
                @endforeach
