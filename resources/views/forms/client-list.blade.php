<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {{ $container_class }}">
    <div class="panel panel-default panel-checkbox">
        <div class="panel-heading">
            ...
            <button class="btn btn-xs btn-default" ng-click="mainList.allCheckBoxes(item.clients, mainList.clientData)" type="button">All</button>
            <button class="btn btn-xs btn-default" ng-click="mainList.noneCheckBoxes(item.clients)" type="button">None</button>
        </div>
                ...
                <li class="checkbox">
                    <label>
                        <input type="checkbox" name="clients[]" value=""
                               ...
                               ng-checked="item.clients.indexOf({{ $item->id }}) > -1">
